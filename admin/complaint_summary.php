...
<html>
	...
	<title>หน้ารายงานข้อร้องเรียน | <?php echo $Srow['project_name_en']; ?></title>
		...
		<div id="fh5co-contact">
			<div class="row">
					...
					<section id="sidebar">
						...
						<aside>
							<ul class="sidebar-navigation">
								...
								<li class="active"><a href="complaint_summary.php"><i class="icon-settings"></i><span> รายงานข้อร้องเรียน</span></a></li>
							</ul>
						</aside>
					</section><!-- /#sidebar -->
				</div><!-- /.col-md-3 -->
				...
				<div class="col-md-7 col-md-push-1 animate-box">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<h4>จำนวนข้อร้องเรียนแยกตามประเภท</h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<h4>จำนวนข้อร้องเรียนแยกตามสถานะ</h4>
    ...
    <!-- Building charts using chart.js -->
    <script src="../js/complaintsbymonth.js"></script>
    <script src="../js/complaintsbytype.js"></script>
    <script src="../js/complaintsbystatus.js"></script>
