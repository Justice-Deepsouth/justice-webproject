...
<html>
  ...
  <h3><?php echo $row['activity_name']; ?></h3>
                    ...
                    <h4 class="text-justify">สถานที่จัดกิจกรรม</h4>
					<p class="text-justify">&emsp; &emsp;<?php echo $row['activity_place']; ?></p>
                    <h4 class="text-justify">วันที่ที่จัดกิจกรรม</h4>
                    <p class="text-justify">&emsp; &emsp;
					<?php 
