...
<html>
	...
	<title>บทความเรื่อง <?= $row['article_title']; ?> | <?php echo $Srow['project_name_en']; ?></title>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 slider-text slider-text-bg">
				   				<div class="slider-text-inner text-center">
				   					<h1><span style="background-color:yellow">บทความ</span></h1>
									<h2><span style="background-color:yellow">รวมบทความมีประโยชน์มากมาย</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
